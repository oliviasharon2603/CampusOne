      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2 relative">
            ...
            {/* Location Badge */}
            <div className="absolute -bottom-6 -right-6 bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-xl flex items-start gap-4 max-w-sm">
              <div className="bg-indigo-100 dark:bg-indigo-900/40 p-3 rounded-full text-indigo-600 dark:text-indigo-400">
                <MapPin className="w-6 h-6" />
              </div>
              <div>
                <h4 className="font-bold text-gray-900 dark:text-white">Premium Location</h4>
                <p className="text-gray-500 dark:text-slate-300 text-sm mt-1">Located in the vibrant educational hub of Trichy, Tamil Nadu.</p>
              </div>
            </div>
          </div>
          
          <div className="lg:w-1/2 lg:pl-8 mt-12 lg:mt-0">
            <h2 className="text-sm font-bold text-indigo-600 dark:text-indigo-400 tracking-widest uppercase mb-3">About Our Campus</h2>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Our Mission</h4>
                  <p className="text-gray-600 dark:text-slate-300">To empower students with a centralized digital campus experience.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Innovation First</h4>
                  <p className="text-gray-600 dark:text-slate-300">Fostering a culture of tech-driven problem solving and creativity.</p>
                </div>
              </div>
            </div>
          </div>
