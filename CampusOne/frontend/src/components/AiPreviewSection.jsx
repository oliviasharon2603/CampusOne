          ...
          <div className="relative">
            ...
            <div className="relative bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden">
              <div className="p-4 border-b border-gray-50 flex items-center space-x-3 bg-gray-50/50">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">CampusOne AI</h4>
                  <p className="text-xs text-green-500 font-medium">Online • Powered by Gemini</p>
                </div>
              </div>
              
              <div className="p-6 space-y-6 h-80 overflow-y-auto bg-gray-50/30">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="bg-white border border-gray-100 text-gray-800 rounded-2xl rounded-tl-none px-4 py-3 shadow-sm max-w-[80%]">
              ...
              <div className="p-4 bg-white border-t border-gray-50">
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-full focus:ring-indigo-500 focus:border-indigo-500 block px-4 py-3 pr-12"
                    readOnly
                  />
                  <button className="absolute inset-y-0 right-1 flex items-center px-3 text-indigo-600 hover:text-indigo-700">
