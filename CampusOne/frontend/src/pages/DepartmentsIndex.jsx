  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300 pb-10">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">Explore faculty, notices, and resources across all 9 branches.</p>
      </div>
        ...
        {departments.map((dept) => (
          ...
          >
            ...
            >
              ...
              <div className="absolute top-4 left-4 bg-white/95 backdrop-blur shadow-sm px-3 py-1 rounded-lg text-xs font-bold text-primary-700">
                {dept.code}
              </div>
            </div>
            ...
            {/* Content */}
            <div className="p-5">
              <h3 className="font-bold text-gray-900 text-lg line-clamp-1 group-hover:text-primary-600 transition-colors mb-2">
                {dept.name}
              </h3>
